...
> 本文件用途：讓接手的 AI 在不重新詢問、不重新推導的情況下，理解這套系統的定位、架構、已確立決策與被否決的方向，直接接續使用或擴充。本文件不上傳 GitHub repository，只作為交接參考。GitHub repository 的實際操作規則見 `AI-Knowledge-System/RULES.md`。
