...
|---|---|---|---|
| Skill Registry | ACTIVE | 提供 Skill 可查詢資訊 | 2-方案/完善/Skill Registry規劃基線-v1.0.md；1-系統/03-Spec/Control Plane Registry 規格.md |
| Blueprint Governance | ACTIVE / 【代】 | 維護 Blueprint 地圖與一致性 | 1-系統/01-Skill/Blueprint Governance Skill（代）.md |
| 會議紀錄管理 | ACTIVE / 【代】 | 管理會議紀錄保存與轉換 | 1-系統/01-Skill/會議紀錄管理 Skill（代）.md |
